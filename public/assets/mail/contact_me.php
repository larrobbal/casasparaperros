...
$email_body = "<html lang='es'>
                  ...
                  <body>
                     <p>Haz recibido un mensaje desde el formulario de tu web http://www.bancas-metalicas.com.mx.</p>
                     ...
                     <table>
                        <tr>
                              <td><img src='http://www.bancas-metalicas.com.mx/assets/img/mail_alt_logo.png' class='img-footer'></td>
...
$email_body_client = "<html lang='es'>
                        ...
                        <body>
                           <p>Haz enviado un mensaje de contacto en la web http://www.bancas-metalicas.com.mx.</p>
                           <p style='font-weight: bold;'>Detalles del mensaje:</p>
                           <span>Nombre:</span> $name<br>
                           <span>Email:</span> $email_address<br>
                           <span>Telefono:</span> $phone<br>
